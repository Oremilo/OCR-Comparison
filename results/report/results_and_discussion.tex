...
\begin{itemize}
    \item Model 'EasyOCR' achieved the highest Character Accuracy at 78.22\% and Word Accuracy at 44.45\%.
    \item Model 'EasyOCR' produced the highest F1-score (0.310), indicating the best balance between precision and recall.
    \item Models PaddleOCR, Tesseract achieved exceptionally low scores (<5\%), suggesting missing underlying dependencies or models failing to initialize properly in this environment.
\end{itemize}
